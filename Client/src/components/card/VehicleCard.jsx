...
<div className="max-w-xs  bg-white border shadow rounded overflow-clip  ">
    <div className='p-1'>
    ...
    <div className="p-5">
        ...
        <div  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#3f37c9] rounded-sm   focus:ring-4 focus:outline-none focus:ring-blue-300 ">
            Contact
